        ...
        <nav className="flex-1 p-4 space-y-1">
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl font-medium transition-all ${
              activeTab === "dashboard" ? "bg-indigo-50 text-indigo-700" : "text-neutral-500 hover:bg-neutral-50"
            }`}
          >
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl font-medium transition-all ${
              activeTab === "users" ? "bg-indigo-50 text-indigo-700" : "text-neutral-500 hover:bg-neutral-50"
            }`}
          >
          ...
          {auth.user?.role === "admin" && (
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl font-medium transition-all ${
                activeTab === "database" ? "bg-indigo-50 text-indigo-700" : "text-neutral-500 hover:bg-neutral-50"
              }`}
            >
                          ...
                          <tr key={user.id} className="hover:bg-neutral-50/50 transition-colors group">
                            ...
                            <td className="px-6 py-4">
                              <span className={`px-2.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${
                                user.role === 'admin' ? 'bg-indigo-50 text-indigo-700' : 'bg-neutral-100 text-neutral-600'
                              }`}>
                                {user.role}
                              </span>
                            </td>
